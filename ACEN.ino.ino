...
// WiFi Credentials
const char* ssid = "AC Party";
const char* password = "suli1990";
...
String htmlPage()
{
  ...
  <head>
      ...
      <title>ACEN PATRICA - INTELLIGENT REMOTE Lighting SYSYEM</title>
      <style>
          body {
  ...
  <body>
      <h1>ACEN PATRICA</h1>
      <h2>REMOTE Intelligent Lighting Dashboard</h2>
      ...
      <footer>&copy; 2025 ACEN PATRICA Systems | TEAM LOGICAL LOOPERS </footer>
  </body>
  </html>
  )rawliteral";
